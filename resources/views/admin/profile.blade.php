    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-lg rounded-5 overflow-hidden">
                ...
                <div class="text-center py-5 text-white" style="background:linear-gradient(135deg,#2563eb,#4f8dfd);">
                    @if(Auth::user()->foto)
                    ...
                    <h3 class="fw-bold mt-4 mb-1">{{ Auth::user()->name }}</h3>
                        ...
                        <div class="list-group-item border-0 py-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold">{{ Auth::user()->instansi ?? '-' }}</div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg rounded-5 overflow-hidden">
                ...
                <div class="card-header border-0 text-white py-4" style="background:linear-gradient(135deg,#2563eb,#4f8dfd);">
    ...
    <div class="modal fade" id="passwordModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-header text-white border-0" style="background:linear-gradient(135deg,#f59e0b,#fbbf24);">
