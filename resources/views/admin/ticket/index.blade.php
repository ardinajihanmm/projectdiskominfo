...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('admin.ticket.export.pdf') }}" class="btn btn-danger btn-export shadow-sm">
                <i class="bi bi-file-earmark-pdf-fill"></i>
                Export PDF
            </a>
            <a href="{{ route('admin.ticket.export.excel') }}" class="btn btn-success btn-export shadow-sm">
    ...
    <div class="filter-box mb-4">
        <form method="GET" action="{{ route('admin.ticket.index') }}">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-lg-4">
                    <label class="form-label fw-semibold">Cari Tiket</label>
                        ...
                        @forelse($tickets as $ticket)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted">Ticket Helpdesk</small>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.ticket.show',$ticket->id) }}" class="btn btn-primary rounded-pill shadow-sm">
                ...
                @forelse($tickets as $ticket)
                    <div class="ticket-card-mobile">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <a href="{{ route('admin.ticket.show',$ticket->id) }}" class="btn btn-primary btn-sm rounded-pill shadow-sm">
                                <i class="bi bi-eye-fill"></i>
                                View
                            </a>
                        </div>
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-2">
        <div class="text-muted">
            Menampilkan <strong>{{ $tickets->count() }}</strong> data tiket
        </div>
        <div>
