...
.login-card:hover { transform:translateY(-4px); box-shadow:0 30px 65px rgba(37,99,235,.25); }
...
.login-divider { margin:15px 0; opacity:.12; }

/* FORM */
.form-label { font-size:.9rem; font-weight:600; color:var(--text); margin-bottom:6px; }
.input-group {
    margin:2px 0; border-radius:999px; overflow:hidden;
    transition:.25s; border:1.5px solid var(--border);
}
.input-group:focus-within { transform:scale(1.01); box-shadow:0 0 0 5px rgba(37,99,235,.14); border-color:var(--primary); }
.input-group-text { width:48px; justify-content:center; background:linear-gradient(135deg,var(--primary),var(--primary-light)); color:#fff; border:none; }
.form-control { height:48px; border:none; font-size:14px; box-shadow:none!important; }
        ...
        <form id="registerForm" action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="instansi" value="{{ old('instansi') }}" class="form-control"
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <button type="button" class="btn password-toggle" onclick="togglePassword('password_confirmation',this)">
                        <i class="bi bi-eye-fill"></i>
                    </button>
                </div>
            </div>
