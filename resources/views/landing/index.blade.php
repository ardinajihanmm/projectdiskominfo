...
@media(max-width:991.98px){
    ...
    .navbar .container-fluid{flex-wrap:wrap;padding:0;}
    .navbar-toggler{padding:7px 9px;box-shadow:none!important;}
    .navbar-collapse{
        width:100%;
        flex-basis:100%;
        padding-top:12px;
    }
    .navbar-nav{align-items:stretch!important;margin:0!important;gap:4px;}
    .nav-link{
        width:100%;
        margin:0;
    ...
    #hero{padding:calc(var(--sp-6) + 82px) 0 var(--sp-6);}
    #hero .row{--bs-gutter-y:2rem;}
    .hero-content{max-width:620px;margin:0 auto;}
    .hero-title .title-small{font-size:2.45rem;}
    .hero-title .title-highlight{font-size:3.15rem;}
    .hero-title .title-big{font-size:3rem;}
    .hero-image{max-width:300px;}
    .hero-right{margin-top:0;}
    .service-grid{max-height:none;overflow:visible;}
    .timeline-track{grid-template-columns:repeat(2,minmax(0,1fr));}
    .footer-top{grid-template-columns:repeat(2,minmax(0,1fr));gap:30px;}
...
@media(max-width:767.98px){
    ...
    .nav-wrap{padding:10px 10px 0;}
    .navbar,
    .nav-wrap.is-scrolled .navbar{padding:10px 12px;border-radius:18px;}
    .logo-pemalang,
    .nav-wrap.is-scrolled .logo-pemalang{width:36px;height:36px;}
    .navbar-brand{gap:9px;max-width:calc(100% - 54px);}
    .brand-title strong{font-size:.9rem;}
    .brand-title small{font-size:.66rem;}
    #hero{padding:118px 0 46px;}
    #hero::before{width:280px;height:280px;right:-130px;}
    #hero::after{width:240px;height:240px;left:-120px;}
    .hero-pattern{background-size:22px 22px;}
    .hero-content{
        width:100%;
        max-width:none;
        align-items:center;
    ...
    .hero-title{align-items:center;margin-bottom:14px;line-height:1.02;}
    .hero-title .title-small{font-size:2rem;}
    .hero-title .title-highlight{font-size:2.55rem;}
    .hero-title .title-big{font-size:2.45rem;}
    .hero-text{font-size:.95rem;line-height:1.65;margin-bottom:8px;}
    .hero-image{width:100%;max-width:260px;height:auto;margin:0 auto;}
    .hero-image img{margin-top:0;}
    .hero-quick{max-width:420px;padding:13px 14px;gap:12px;}
    .hero-quick-icon{width:40px;height:40px;}
    .hero-right{padding:16px;border-radius:18px;}
    .hero-search{margin-bottom:14px;}
    .hero-search i{left:17px;}
    .hero-search input{padding:15px 54px 15px 45px;font-size:.9rem;}
    .hero-search-btn{width:40px;height:40px;right:5px;}
    ...
    .service-label{min-height:50px;padding:9px 8px;font-size:.75rem;}
    .service-arrow{top:9px;right:9px;width:28px;height:28px;}
    .section-title{margin-bottom:30px;}
    .section-title h2{font-size:1.75rem;}
    .section-title p{font-size:.93rem;line-height:1.7;}
    .timeline{padding:20px 18px;border-radius:18px;}
    ...
    .timeline-no{top:-4px;right:-4px;width:22px;height:22px;}
    .timeline-step h5{align-self:end;margin:0 0 3px;font-size:.96rem;}
    .timeline-step p{align-self:start;margin:0;font-size:.82rem;}
    .timeline-cta{margin-top:24px;}
    .timeline-cta .btn-hero-primary{width:100%;justify-content:center;text-align:center;}
    .footer-top{grid-template-columns:1fr;gap:26px;padding:28px 0 22px;}
    .footer-col:first-child{grid-column:auto;}
    .footer-col p{max-width:none;}
    .footer-bottom{justify-content:center;text-align:center;padding:12px 0;}
    .chat-fab{right:16px;bottom:16px;width:52px;height:52px;font-size:1.25rem;}
    .back-to-top{right:20px;bottom:80px;width:40px;height:40px;}
    .chat-panel{right:14px;bottom:80px;width:min(320px,calc(100vw - 28px));}
    .modal-dialog{margin:12px;}
    .modal-body{padding:18px!important;}
    .modal-body .row{--bs-gutter-y:1rem;}
    .service-desc-body{max-height:52vh;padding-right:4px;font-size:.9rem;}
    .desc-indent-1{margin-left:.8em;}
    .desc-indent-2{margin-left:1.6em;}
    .desc-indent-3{margin-left:2.4em;}
...
@media(max-width:479.98px){
    ...
    .hero-title .title-small{font-size:1.75rem;}
    .hero-title .title-highlight{font-size:2.2rem;}
    .hero-title .title-big{font-size:2.1rem;}
    .hero-right{padding:13px;}
    .hero-search input{font-size:.84rem;}
    .service-grid{grid-template-columns:1fr;}
    .service-thumb{height:150px;}
    .service-label{font-size:.82rem;}
    .hero-quick-text strong{font-size:.88rem;}
    .hero-quick-text small{font-size:.75rem;}
    .section-title h2{font-size:1.55rem;}
    .timeline{padding:16px 14px;}
    .timeline-step{grid-template-columns:54px minmax(0,1fr);column-gap:11px;}
    .timeline-icon{width:50px;height:50px;font-size:1.15rem;}
    .timeline-no{width:20px;height:20px;font-size:.65rem;}
    .chat-panel{left:10px;right:10px;width:auto;}
}
@media(hover:none){
    .service-card:hover,
    .contact-card:hover,
    ...
    .btn-login:hover,
    .btn-hero-primary:hover,
    .btn-hero-outline:hover{transform:none;}
}
</style>
