...
<head>
    ...
    <style>
        ...
        .sidebar {
            width: 260px;
            height: 100vh;
            background: linear-gradient(180deg, #0d6efd, #2563eb, #1e40af);
            display: flex;
...
>>>>>>> 577cec2dce9cd0d88d94c6936adabf1f8a07c7ca
            }
...
<body>
    ...
    <div class="content">
        <div class="topbar">
            <button type="button" class="btn btn-light border-0 me-3" id="toggleSidebar"
                    aria-label="Buka menu" aria-controls="sidebarMenu" aria-expanded="false">
                <i class="bi bi-list fs-3"></i>
            </button>
