            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-md-3">
                    <select name="status" class="form-select">
                        ...
                        <option value="To Do" {{ $status == 'To Do' ? 'selected' : '' }}>
                            To Do
                        </option>
                ...
                <div class="col-md-2 d-grid">
                    <a href="{{ route('staff.ticket.index') }}" class="btn btn-outline-secondary">
                        Reset
                    </a>
                </div>
            </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                ...
                                <br>
                                <span class="text-muted">Tidak ada data tiket.</span>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
