        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-5">
                ...
                <div class="upload-box">
                    ...
                    <h6>Unggah Lampiran (Opsional)</h6>
                    <p class="text-muted mb-3">Foto atau dokumen pendukung dapat membantu petugas memahami permasalahan Anda.</p>
                    <input type="file" name="lampiran" class="form-control modern-input" accept=".jpg,.jpeg,.png,.pdf">
                ...
                <div class="tips-box mt-4">
                    ...
                    <div>
                        <strong>Tips</strong>
                        <p class="mb-0">Pastikan judul dan deskripsi sesuai dengan kebutuhan Anda agar proses penanganan menjadi lebih cepat.</p>
                    </div>
                </div>

                <div class="d-flex justify-content-end gap-3 mt-5">
                    <a href="{{ route('user.dashboard') }}" class="btn btn-light px-4 py-2 rounded-pill">Kembali</a>
